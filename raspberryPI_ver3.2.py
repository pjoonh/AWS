...
def save_data_to_csv(temperature, humidity, pressure):
    ...
    print(f"Dew Point: {Dew_point}, Pressure: {pressure} hPa")
...
def plot_graph():
    ...
    # Filter out pressure values below 1000 hPa
    data = data[data['Pressure (hPa)'] >= 1000]
        ...
        with serial.Serial(SERIAL_PORT, BAUD_RATE, timeout=10) as ser:
            while True:
                ...
                if line.startswith("Temperature:"):
                    ...
                    pressure=float(pressure_str)+10 #add pressure, correction offset:+10hPa
                    
                    save_data_to_csv(temperature, humidity, pressure)
                    plot_graph()
